...
/***
 * Entidad ConfiguraciónCupos. Clase que representará la configuración que
 * tendrán los cupos donde irán las citas.
 * 
 * @author Equipo3
 *
 */
...
public class ConfiguracionCupos {
	...
	/***
	 * Constructor para la creación de la configuración de cupos sin pasar valores
	 * de esta configuración. Se crea un identificador aleatorio.
	 */
	...
	/***
	 * Método para la actualización de la duración en minutos de la jornada del
	 * cupo.
	 * 
	...
	/***
	 * Método para la actualización de la fecha de inicio en la que se activará el
	 * cupo.
	 * 
	 * @param fechaInicio; devolución de la fecha de inicio en la que se activará el
	 *                     cupo.
	 */
	 ...
	 * EN FORMATO DATE.
	 * 
	 * @return formateador.parse(fechaInicio); devolución de la fecha de inicio en
	 *         la que se activará el cupo EN FORMATO DATE.
	 */
	...
	/***
	 * Método para la devolución de la fecha de inicio en la que se activará el
	 * cupo.
	 * 
	 * @return fechaInicio; devolución de la fecha de inicio en la que se activará
	 *         el cupo.
	 */
	 ...
	 * 
	 * @return fechaFin; devolución de la fecha de FIN en la que se finalizará el
	 *         cupo.
	 */
